...
const MOCK_RESPONSES: Record<TaskType, string> = {
  docs: 'Based on the Banza protocol documentation, I can answer your question. [mock response — configure BANZAMIA_MODE=live-ai and a vLLM endpoint for real model inference]',
  ...
  reasoning: 'This requires deep reasoning about the Banza protocol. [mock response — configure DeepSeek via BANZAMIA_VLLM_URL for reasoning tasks]',
