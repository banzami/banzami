...
For the authoritative invariant definitions, see [BANZA_REFERENCE.md §7](BANZA_REFERENCE.md).
...
```markdown
![Protocol Compatible](https://raw.githubusercontent.com/banza-protocol/banza/main/conformance/badges/protocol-compatible.svg)
![Trace Compatible](https://raw.githubusercontent.com/banza-protocol/banza/main/conformance/badges/trace-compatible.svg)
![Federation Ready](https://raw.githubusercontent.com/banza-protocol/banza/main/conformance/badges/federation-ready.svg)
![Settlement Compatible](https://raw.githubusercontent.com/banza-protocol/banza/main/conformance/badges/settlement-compatible.svg)
```
...
- `docs/conformance.md` — Detailed conformance documentation
- `conformance/vectors/` — Test vector files
- `contracts/sdk-certification/` — SDK compliance vectors
