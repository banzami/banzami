...
- [BANZA_REFERENCE.md §11](BANZA_REFERENCE.md) — Roadmap do Protocolo (fonte canónica)
...
- [BANZA_GOVERNANCE.md](BANZA_GOVERNANCE.md) — Protocol governance and ADR process
